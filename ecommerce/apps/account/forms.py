...
class UserAddressForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["phone"].widget.attrs.update({"class": "form-control mb-2 account-form"})
        self.fields["address_line"].widget.attrs.update({"class": "form-control mb-2 account-form"})
        self.fields["address_line2"].widget.attrs.update({"class": "form-control mb-2 account-form"})
        self.fields["town_city"].widget.attrs.update({"class": "form-control mb-2 account-form"})
        self.fields["postcode"].widget.attrs.update({"class": "form-control mb-2 account-form"})
...
class PwdResetForm(PasswordResetForm):
    ...
    def clean_email(self):
        ...
        if not customer:
            raise forms.ValidationError("Unfortunatley there is no user with this email")
        return email
